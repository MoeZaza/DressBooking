...
/**
 * Minimum rental duration in hours. Default is 1 hour.
...
/**
 * Minimum required time in hours before rental start. Default is 1 hour.
 * Should be equal to 1 hour or higher.
 *
 * @type {number}
 */
let MIN_RENTAL_START_HOURS = Number.parseInt(String(import.meta.env.VITE_BC_MIN_RENTAL_START_HOURS), 10) || 1

if (MIN_RENTAL_START_HOURS < 1) {
