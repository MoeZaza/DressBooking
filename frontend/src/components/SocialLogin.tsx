  ...
  return (
    <div className={`${className ? `${className} ` : ''}social-login`}>
      ...
      <div className="login-buttons">
        {facebook && env.FB_APP_ID && env.FB_APP_ID !== 'your_facebook_app_id_here' && (
          <LoginSocialFacebook
            appId={env.FB_APP_ID}
        ...
        {facebook && (!env.FB_APP_ID || env.FB_APP_ID === 'your_facebook_app_id_here') && (
          <div className="social-placeholder">
            <img alt="Facebook" src={FacebookIcon} className="social disabled" />
            <span className="social-disabled-text">Facebook Login (Configure FB_APP_ID)</span>
          </div>
        )}
        ...
        {google && env.GG_APP_ID && env.GG_APP_ID !== 'your_google_app_id_here' && (
          <LoginSocialGoogle
        ...
        {google && (!env.GG_APP_ID || env.GG_APP_ID === 'your_google_app_id_here') && (
          <div className="social-placeholder">
            <img alt="Google" src={GoogleIcon} className="social disabled" />
            <span className="social-disabled-text">Google Login (Configure GG_APP_ID)</span>
          </div>
        )}
      </div>
    </div>
