...
Si tiene alguna pregunta sobre esta Política de Cookies, puede contactarnos en: ${env.CONTACT_EMAIL}
  ...
  ar: {
    ...
    POLICY: `
تشرح سياسة ملفات تعريف الارتباط هذه كيف يستخدم ${env.WEBSITE_NAME} ("نحن" أو "لنا" أو "خاصتنا") ملفات تعريف الارتباط والتقنيات المماثلة على موقعنا الإلكتروني. باستخدام موقعنا الإلكتروني، فإنك توافق على استخدام ملفات تعريف الارتباط كما هو موضح في هذه السياسة.

1. ما هي ملفات تعريف الارتباط؟

ملفات تعريف الارتباط هي ملفات نصية صغيرة يتم تخزينها على جهازك (الكمبيوتر أو الجهاز اللوحي أو الهاتف الذكي) عند زيارة موقع ويب. تساعد في تحسين تجربة التصفح الخاصة بك من خلال تذكر تفضيلاتك وتوفير المعلومات أو الخدمات ذات الصلة.

2. أنواع ملفات تعريف الارتباط التي نستخدمها

نستخدم الأنواع التالية من ملفات تعريف الارتباط:

- ملفات تعريف الارتباط الضرورية بشكل صارم: هذه الملفات ضرورية لعمل الموقع ولا يمكن إيقاف تشغيلها في أنظمتنا.
- ملفات تعريف الارتباط للأداء: تساعدنا هذه الملفات على فهم كيفية تفاعل الزوار مع موقعنا من خلال جمع المعلومات والإبلاغ عنها بشكل مجهول.
- ملفات تعريف الارتباط الوظيفية: تمكن هذه الملفات الموقع من توفير وظائف محسنة وتخصيص.
- ملفات تعريف الارتباط الإعلانية/الاستهدافية: تُستخدم هذه الملفات لتقديم إعلانات ذات صلة وتتبع أداء الإعلانات.
...
يمكنك إدارة تفضيلات ملفات تعريف الارتباط في أي وقت عن طريق ضبط الإعدادات في متصفحك. تسمح لك معظم المتصفحات بـ:
...
5. ملفات تعريف الارتباط من طرف ثالث

قد نسمح لمقدمي الخدمات من طرف ثالث بوضع ملفات تعريف الارتباط على موقعنا لتحليل حركة المرور أو تقديم خدمات إعلانية أو تمكين ميزات إضافية. تخضع هذه الملفات لسياسات الخصوصية الخاصة بالأطراف الثالثة.

6. التغييرات على سياسة ملفات تعريف الارتباط هذه

قد نقوم بتحديث سياسة ملفات تعريف الارتباط هذه من وقت لآخر لتعكس التغييرات في التكنولوجيا أو التشريع أو ممارساتنا. ستُنشر السياسة المحدثة على هذه الصفحة مع تاريخ "آخر تحديث" منقح.

7. اتصل بنا

إذا كان لديك أي أسئلة حول سياسة ملفات تعريف الارتباط هذه، يرجى الاتصال بنا على: ${env.CONTACT_EMAIL}
    `,
  },
})
