...
Al utilizar nuestros servicios, usted reconoce que ha leído y comprendido estos Términos de servicio y acepta regirse por ellos.
  ...
  ar: {
    TITLE: 'شروط الخدمة',
    TOS: `
مرحباً بك في ${env.WEBSITE_NAME}! من خلال الوصول إلى موقعنا الإلكتروني واستخدام خدماتنا، فإنك توافق على الامتثال والالتزام بشروط الخدمة التالية. إذا كنت لا توافق على هذه الشروط، يرجى عدم استخدام خدماتنا.
...
جميع إيجارات الفساتين تخضع لشروط الإيجار الخاصة بنا. أنت مسؤول عن التأكد من استيفاء جميع المتطلبات قبل إجراء حجز.
...
تخضع شروط الخدمة هذه وتفسر وفقاً للقوانين. أي نزاعات تنشأ عن هذه الشروط ستحل في المحاكم.
