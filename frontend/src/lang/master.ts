...
const strings = new LocalizedStrings({
  ...
  ar: {
    VALIDATE_EMAIL: 'تم إرسال بريد إلكتروني للتحقق إلى عنوان بريدك الإلكتروني. يرجى التحقق من صندوق البريد والتحقق من حسابك بالنقر على الرابط في البريد الإلكتروني. سينتهي صلاحيته بعد يوم واحد. إذا لم تتلق بريد التحقق الإلكتروني، انقر على إعادة الإرسال.',
