...
const strings = new LocalizedStrings({
  fr: {
    ...
    STATUS_MESSAGE: "Vérifiez votre boîte mail et suivez les étapes décrites dans l'e-mail de confirmation de réservation pour réserver votre robe.",
  },
  en: {
    ...
    STATUS_MESSAGE: 'Check your mailbox and follow the steps described in the booking confirmation email to book your dress.',
  },
  es: {
    ...
    STATUS_MESSAGE: 'Revise su buzón de correo y siga los pasos descritos en el correo electrónico de confirmación de reserva para reservar su vestido.',
  },
  ar: {
    CONGRATULATIONS: 'تهانينا!',
    SUCCESS: 'تم الدفع بنجاح. لقد أرسلنا لك بريد إلكتروني للتأكيد.',
    SUCCESS_PAY_LATER: 'تم الحجز بنجاح. لقد أرسلنا لك بريد إلكتروني للتأكيد.',
    ERROR: 'حدث خطأ ما! حاول مرة أخرى لاحقاً',
    STATUS_TITLE: `${env.WEBSITE_NAME} تأكيد الحجز`,
    STATUS_MESSAGE: 'تحقق من صندوق البريد واتبع الخطوات الموضحة في بريد تأكيد الحجز لحجز فستانك.',
  },
})
