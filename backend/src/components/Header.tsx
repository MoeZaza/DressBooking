  ...
  const renderMenu = (
    ...
    >
      ...
      {currentUser && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Avatar record={currentUser} type={currentUser.type} size="medium" readonly />
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px', marginTop: '2px' }}>
                <RoleIcon sx={{ fontSize: 14 }} color="primary" />
                <Typography variant="caption" color="primary" fontWeight="medium">
                  {helper.getUserType(currentUser.type as bookcarsTypes.UserType)}
                </Typography>
              </div>
            </div>
          </div>
      ...
      <MenuItem onClick={handleProfileClick}>
        <ProfileIcon className="header-action" />
        <Typography>{strings.PROFILE || 'Profile'}</Typography>
      </MenuItem>
          ...
          <>
            ...
            >
              <List sx={classes.list}>
                ...
                >
                  <ListItemIcon><DashboardIcon /></ListItemIcon>
                  <ListItemText primary={strings.BOOKING_MANAGEMENT || 'Booking Management'} />
                </ListItem>
                <ListItem
                  onClick={() => {
                    navigate('/scheduler')
                ...
                <ListItem
                  onClick={() => {
                    navigate('/fitting-appointments')
                    handleSideMenuClose()
                  }}
                >
                  <ListItemIcon><FittingIcon /></ListItemIcon>
                  <ListItemText primary={strings.FITTING_APPOINTMENTS} />
                </ListItem>
                <ListItem
                  onClick={() => {
                    navigate('/suppliers')
                ...
                <ListItem
                  onClick={() => {
                    navigate('/dress-search')
                    handleSideMenuClose()
                  }}
                >
                  <ListItemIcon><SearchIcon /></ListItemIcon>
                  <ListItemText primary={strings.DRESS_SEARCH_ANALYTICS || 'Dress Search & Analytics'} />
                </ListItem>

                <ListItem
                  onClick={() => {
                    navigate('/dress-inventory')
                    handleSideMenuClose()
                  }}
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.DRESS_INVENTORY || 'Dress Inventory'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.FITTING_APPOINTMENTS || 'Fitting Appointments'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.PAYMENT_MANAGEMENT || 'Payment Management'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.EXPENSE_MANAGEMENT || 'Expense Management'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.ACCOUNTING_DASHBOARD || 'Accounting Dashboard'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.CUSTOMER_MANAGEMENT || 'Customer Management'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.ADMIN_DASHBOARD || 'Admin Dashboard'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.ANALYTICS_DASHBOARD || 'Analytics Dashboard'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.INVENTORY_MANAGEMENT || 'Inventory & Accounting'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.BUSINESS_INTELLIGENCE || 'Business Intelligence'} />
                </ListItem>
                ...
                >
                  <ListItemIcon><CheckroomIcon /></ListItemIcon>
                  <ListItemText primary={strings.WEDDING_PACKAGES || 'Wedding Packages'} />
                </ListItem>
                <ListItem
                  onClick={() => {
                    navigate('/users')
                ...
                <ListItem
                  onClick={() => {
                    navigate('/accessory-settings')
                    handleSideMenuClose()
                  }}
                >
                  <ListItemIcon><SettingsIcon /></ListItemIcon>
                  <ListItemText primary={strings.ACCESSORY_SETTINGS || 'Accessory Settings'} />
                </ListItem>
