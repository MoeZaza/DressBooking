...
import { ar, fr, enUS, es } from 'date-fns/locale'
...
const DateTimePicker = ({
  ...
  return (
    <LocalizationProvider adapterLocale={language === 'ar' ? ar : language === 'fr' ? fr : language === 'es' ? es : enUS} dateAdapter={AdapterDateFns}>
      <MuiDateTimePicker
        label={label}
        value={value}
        readOnly={readOnly}
