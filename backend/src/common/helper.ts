...
export const getDressType = (type: string) => {
  switch (type) {
    ...
    case bookcarsTypes.DressType.Other:
...
export const getDressSize = (size: string) => {
  switch (size) {
    ...
    case bookcarsTypes.DressSize.DoubleExtraLarge:
      return strings.DOUBLE_EXTRA_LARGE
...
export const getDressSizeTooltip = (size: string) => {
  switch (size) {
    case bookcarsTypes.DressSize.ExtraSmall:
      return strings.EXTRA_SMALL_TOOLTIP
    ...
    case bookcarsTypes.DressSize.DoubleExtraLarge:
      return strings.DOUBLE_EXTRA_LARGE_TOOLTIP

    case bookcarsTypes.DressSize.Custom:
      return strings.CUSTOM_TOOLTIP
