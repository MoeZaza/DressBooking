...
export const en = {
  ...
  DRESS_IMAGE_REQUIRED: "Dress image field can't be blank: ",
  DRESS_IMAGE_NOT_FOUND: 'Image file not found: ',
  ...
  BOOKING_CONFIRMED_PART6: ` (${env.TIMEZONE}) to pick up your dress `,
  BOOKING_CONFIRMED_PART7: '.',
  BOOKING_CONFIRMED_PART8: 'Please bring your ID and warranty check with you.',
  BOOKING_CONFIRMED_PART9: 'You must return the dress to our agency ',
  ...
  NEW_DRESS_NOTIFICATION_PART1: 'The supplier ',
  NEW_DRESS_NOTIFICATION_PART2: ' created a new dress.',
}
