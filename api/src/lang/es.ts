...
export const es = {
  ...
  DRESS_IMAGE_REQUIRED: 'El campo de imagen del vestido no puede estar vacío: ',
  DRESS_IMAGE_NOT_FOUND: 'Archivo de imagen no encontrado: ',
  ...
  BOOKING_CONFIRMED_PART6: ` (${env.TIMEZONE}) para recoger su vestido `,
  BOOKING_CONFIRMED_PART7: '.',
  BOOKING_CONFIRMED_PART8: 'Por favor, traiga su identificación y el cheque de garantía.',
  BOOKING_CONFIRMED_PART9: 'Debe devolver el vestido en nuestra agencia ',
  BOOKING_CONFIRMED_PART10: ' (',
  BOOKING_CONFIRMED_PART11: ') el ',
  BOOKING_CONFIRMED_PART12: ` (${env.TIMEZONE}).`,
  BOOKING_CONFIRMED_PART13: 'Por favor, respete las fechas y horarios de recogida y devolución del vestido.',
  ...
  NEW_DRESS_NOTIFICATION_PART1: 'El proveedor ',
  NEW_DRESS_NOTIFICATION_PART2: ' creó un nuevo vestido.',
}
