...
export const fr = {
  ...
  DRESS_IMAGE_REQUIRED: 'Le champ image de Car ne peut pas être vide: ',
  DRESS_IMAGE_NOT_FOUND: 'Le fichier image est introuvable : ',
  ...
  NEW_DRESS_NOTIFICATION_PART1: 'Le fournisseur ',
  NEW_DRESS_NOTIFICATION_PART2: ' a créé une nouvelle voiture.',
}
